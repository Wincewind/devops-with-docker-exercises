```shell
\Part_1\exercise_1.8>docker build . -t web-server
...
View build details: docker-desktop://dashboard/build/default/default/w7589i595ikk8jfqt7363802m

What's Next?
  1. Sign in to your Docker account → docker login
  2. View a summary of image vulnerabilities and recommendations → docker scout quickview

\Part_1\exercise_1.8>docker run web-server
