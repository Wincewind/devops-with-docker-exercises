Used commands:
```shell
docker run -d -it --name ex14 ubuntu sh -c "while true; do echo 'Input website:'; read website; echo 'Searching..'; sleep 1; curl http://$website; done"
docker exec -it ex14 bash -c "apt-get update && apt-get -y install curl"
docker attach ex14
```
Results:
```shell
>docker run -d -it --name ex14 ubuntu sh -c "while true; do echo 'Input website:'; read website; echo 'Searching..'; sleep 1; curl http://$website; done"
f06263a289127c2da556a489a33eacf1849cf66648ff32084762a1a34dd427c1
...
Fetched 22.1 MB in 11s (1963 kB/s)
...
The following NEW packages will be installed:
  ca-certificates curl krb5-locales libbrotli1 libcurl4t64 libdb5.3t64 libgssapi-krb5-2 libk5crypto3 libkeyutils1 libkrb5-3 libkrb5support0 libldap-common libldap2
...
Fetched 4295 kB in 1s (5603 kB/s)
...
What's next?
  Try Docker Debug for seamless, persistent debugging tools in any container or image → docker debug ex14
